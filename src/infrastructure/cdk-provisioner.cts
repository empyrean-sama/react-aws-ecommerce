...
const profileStack = new ProfileStack(app, Constants.profileStackOutputKey, { profilesTable: authStack.profilesTable, apiStack: apiStack, env });
...
const productStack = new ProductStack(app, Constants.productStackOutputKey, { apiStack, env, authAPIStack: authApiStack, memoryBucket: memoryStack.memoryBucket });
